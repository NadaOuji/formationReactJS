...
// const meme = JSON.parse(' {"id": 0,"nom": "hyperGreen","text": {"x": 400,"y": 500,"value": "hyper green !!","color": "#00AF00","bold": false,"underline": true},"imageId": 4}')
...
return (
  <div className={styles.Thumbnail} data-testid="Thumbnail">
    ...
    {memes.map((e,i)=>
    <Link to={'/editor/'+e.id}>
    <MemeViewer meme={{...e,image:props.images.find(ee=>ee.id === e.imageId)}} key={'thumb-'+i}/>    </Link>)}
    </FlowLayout>
  </div>
);}
